...
MTV Collision::getCollision(const sf::Sprite& object1, ENTITY_SHAPE shape1, const sf::Sprite& object2, ENTITY_SHAPE shape2) {
	...
	if (shape1 == SHAPE_CIRCLE && shape2 == SHAPE_CIRCLE) {
		...
		OBB* square = (shape1 == SHAPE_SQUARE ? &obb1 : &obb2);
